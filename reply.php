<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_ins = "insert into reply(content_id,content_reply,member_id,reply_time) values({$_GET['cid']}, '{$clean['content_reply']}', $member_id, now())";
        execute($link, $sql_ins);
        if (mysqli_affected_rows($link)) {
                skip("show.php?cid={$_GET['cid']}", '回复留言成功，页面自动跳转中.....');
                exit();
            }else{
        ...
        <div id="list">
            <div id="list-main">
                ...
                <div class="list-main-box">
                    <div class="wrapper">
                        <p class="reply_title">回复由 <span><?php echo $data_sel_mem['name']?></span> 发布的：</p>
                        <p class="cont"><?php echo $data_sel_cont['content']?></p>
                    </div>
